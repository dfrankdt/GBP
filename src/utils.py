...
"""
We create routines to produce figures that illustrate
 - trajectories in the phase plane for xi < 0 (i.e. outside gel)
 - trajectories in the phase plane for xi > 0 (i.e. inside gel)
 - the unique saddle-saddle trajectory
 - the gel-buffer potential, saturating to the Donnan potential
"""
# ======================================
# Packages
# ======================================
...
def doGBplots(kap_range, C0):
	# --- Find gel-buffer values for each kappa, C0
